...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
	...
	<div class="content">
            ...
            <h1><center>Course Record</center></h1>
            <br>
            <center>
            ...
            <table border="1px">
               <!-- comment -->
                ...
                <tr>
                    <th class="table-th">Course ID</th>
...
session.setAttribute("username",courseid);
%>
 
<tr>
    
    
    <td class="table-td"><%=rs.getString("courseid")%></td>
    <td class="table-td"><%=rs.getString("cname")%></td>
    <td class="table-td"><%=rs.getString("duration")%></td>
