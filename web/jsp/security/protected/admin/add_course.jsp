...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.1.0/dist/sweetalert2.all.min.js"></script>
	...
	<div class="content">
            ...
            <div class="div_deg">
                <form method="POST" action="add_course db.jsp" >
            ...
            <div>
                <form id="myForm">
                    ...
                    <div>
                        ...
                        <input type="text" name="courseid" id="course_id" pattern="[0-9]{3,5}" required>
                        
                    </div>
                    <div>
                        <label>Course Name</label>
                        <input type="text" name="cname" id="c_name" pattern="[a-zA-Z]+\.[a-zA-Z]+{1,32}" required>
                    ...
                    <div>
                        <input type="submit" id="submit" name="add_course" class="btn btn-primary"value="Add Course">
	...
	<link rel="stylesheet" href="alert/dist/sweetalert.css">
        ...
        <script type="text/javascript">
            ...
            if(status === "success"){
            swal("Congrats","Course Added","success");
        }
        </script>
</body>
</html>
