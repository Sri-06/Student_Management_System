            ...
            <table border="1px">
               <!-- comment -->
                ...
                <tr>
                    ...
                    <th class="table-th">CGPA</th>
                    <th class="table-th">Edit</th>
                    <th class="table-th">Delete</th><!-- comment -->
...
<tr>
    ...
    <td class="table-td"><a href="update.jsp?id=<%=rollno%>">Update</a></td>
    <td class="table-td"><a href="stu_del.jsp">Delete</a></td>
</tr><%}
}catch(Exception e)
            {
            out.println(e);
